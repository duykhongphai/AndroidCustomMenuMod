...
public final class OnyxBackgroundView extends View {
    ...
    public OnyxBackgroundView(Context context) {
        this(context, null);
    }

    public OnyxBackgroundView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
