package com.nguyen.androidcustommenumod;
...
public final class MainActivity extends Activity {
    ...
    private View createContent() {
        ...
        root.addView(new NebulaBackgroundView(this), new FrameLayout.LayoutParams(
        ...
        TextView intro = Design.text(
                this,
                "Nebula is a modern floating control surface built entirely with Android Views and Canvas — portable, themeable and easy to understand.",
                15,
                0xFFB2BCD0
        );
    ...
    private View createTopBar() {
        ...
        TextView name = Design.title(this, "NEBULA", 15);
    ...
    private void startOverlayService() {
        ...
        Toast.makeText(this, "Nebula overlay launched", Toast.LENGTH_SHORT).show();
        updateStatus();
    }
