...
Java_com_nguyen_onyxmenu_nativebridge_NativeDemoRuntime_nativeSetToggle(
        JNIEnv* environment,
        jclass,
        jstring featureId,
        jboolean enabled
...
extern "C" JNIEXPORT void JNICALL
Java_com_nguyen_onyxmenu_nativebridge_NativeDemoRuntime_nativeSetValue(
        JNIEnv* environment,
        jclass,
        jstring featureId,
        jfloat value
...
extern "C" JNIEXPORT void JNICALL
Java_com_nguyen_onyxmenu_nativebridge_NativeDemoRuntime_nativeSetChoice(
        JNIEnv* environment,
        jclass,
        jstring featureId,
        jstring optionId
...
extern "C" JNIEXPORT void JNICALL
Java_com_nguyen_onyxmenu_nativebridge_NativeDemoRuntime_nativePerformAction(
        JNIEnv* environment,
        jclass,
        jstring actionId
) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_nguyen_onyxmenu_nativebridge_NativeDemoRuntime_nativeReset(
        JNIEnv*,
        jclass
) {
...
Java_com_nguyen_onyxmenu_nativebridge_NativeDemoRuntime_nativeSnapshot(
        JNIEnv* environment,
        jclass
) {
    const std::string snapshot = onyx::demo::nativeState().snapshot();
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_nguyen_onyxmenu_nativebridge_NativeDemoRuntime_nativeRunOwnedOffsetLab(
        JNIEnv* environment,
        jclass
) {
