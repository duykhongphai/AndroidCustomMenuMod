package com.nguyen.onyxmenu.nativebridge;

/**
 * Small Java API over the process-local C++ demo state.
 *
 * The native library is packaged inside an app that depends on this module. It
 * does not access another application's process and contains no hook or
